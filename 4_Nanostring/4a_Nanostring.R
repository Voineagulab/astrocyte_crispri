## In this script, we analyse Nanostring validation data
...
## Setup
  rm(list = ls())
  gc()
  setwd("/mnt/Data0/PROJECTS/CROPSeq/Validation_RNAseq/Nanostring/Results/Final_Revised/")
...
## Read in and normalise expression
  # paths1 <- list.files("../../Ramaciotti/Updated_RCC/20230726_210582350125_RCC_GOK12461/", pattern = "300ng", full.names = TRUE) # keep only samples at 300ng concentration, not 150
  paths1 <- "../../Ramaciotti/Updated_RCC/20230726_210582350125_RCC_GOK12461/"
...
## Read in metadata
  meta$b1 <- read_xlsx("../../Ramaciotti/Updated_RCC/SampleOrder_V2.xlsx", sheet = "Run1")
...
## Read in and normalise expression
  paths23 <- c("../../Ramaciotti/Updated_RCC/GOK12461 batch 2rpt 20230911_210611690225_RCC/",
             "../../Ramaciotti/Updated_RCC/GOK12461 Batch3 20230830_210611660225_RCC/")
...
## Read in metadata
  meta$b23 <- list(read_xlsx("../../Ramaciotti/Updated_RCC/SampleOrder_V2.xlsx", sheet = "Run2"),
                 read_xlsx("../../Ramaciotti/Updated_RCC/SampleOrder_V2.xlsx", sheet = "Run3"))
...
## Read in and normalise expression
  paths45 <- c("../../Ramaciotti/Updated_RCC/GOK12461 Batch 4 20230911_210611680225_RCC/",
             "../../Ramaciotti/Updated_RCC/GOK12461 cartridge 5 20230915_210611700225_RCC/")
...
## Read in metadata
  meta$b45 <- list(read_xlsx("../../Ramaciotti/Updated_RCC/SampleOrder_V2.xlsx", sheet = "Run4"),
                 read_xlsx("../../Ramaciotti/Updated_RCC/SampleOrder_V2.xlsx", sheet = "Run5"))
