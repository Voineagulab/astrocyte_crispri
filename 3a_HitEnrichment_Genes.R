...
## Generic
rm(list = ls()); gc()
setwd("/Volumes/share/mnt/Data0/PROJECTS/CROPSeq/FullScale/Results/3_HitEnrichment/")
...
## LPS activation timecourse of mouse astrocytes in vivo
  ...
  ## Read in
    ...
    get_hasel_bulkDEGs <- function(y, fix = TRUE) {
    ...
    hasel_rat$Human <- convert_rat2human(hasel_rat$SYMBOL, path.fix = TRUE)
    ...
    hasel_sc$Human <- convert_mouse2human(hasel_sc$Gene_name, path.fix = TRUE)
