# This script processes outputs generated by the TOBIAS pipeline, compares the total number of TF-bound and unbound sites between hits and non-hits,  
# and creates files for visualization in the UCSC browser.
