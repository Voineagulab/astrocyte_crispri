##########
##
#This script defines a function for processing the aggregated signal footprinting data generated by TobiasAggregatePlots.sh and prepares it for visualization in R.
